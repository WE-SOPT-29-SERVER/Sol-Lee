...
let arr3 = ['이솔', 1, 2, 3, null, { name: 'sol', age: 24 }];
console.log(arr3);
console.log(typeof arr3);

//배열 prototype 매서드

console.log('******Array 기본함수들을 알아보자*********');
let arr = [1, 2, 3, 4];
...
countries = ['Österreich', 'Andorra', 'Vietnam', 'Korea', 'China'];
countriesLengths = countries.map((item) => item.length);
